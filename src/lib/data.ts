...
export const PAGE_ICON = ":wave:";
export const NAME = "Gaspard Hassenforder";
export const DESCRIPTION = "AI Engineer & Data Scientist specializing in autonomous multi-agent systems, RAG architectures, and scalable AI solutions. Passionate about bridging the gap between research and production to drive business value. Expert in Python, TypeScript, and cloud infrastructure.";
...
export const PROJECTS = [
    {
        ...
        description: "Won First Place at a hackathon sponsored by Meta, Hugging Face, Scalaway, and Entrepreneur First. Developed 'NamastAI,' a yoga assistant app integrating multiple AI models for real-time pose correction and audible feedback. Prize: €3,000 + recognition for technical innovation and commercial viability."
    },
    {
    ...
    },
    {
        ...
        description: "Developed an MCP (Model Context Protocol) integration enabling AI to interact with LeoCAD, a specialized CAD software for LEGO designs. Created an automated system that generates LEGO models from images or text descriptions using AI, with planned functionality for automatic parts ordering."
    },
    {
        title: "Trained HRM for Queens Game",
        description: "Leveraged the Hierarchical Reasoning Model (HRM) architecture to solve the Queens LinkedIn puzzle game. Created a comprehensive training dataset by exploiting the game's inherent symmetries for data augmentation. The model's ability to handle fixed-size grids made it particularly well-suited for this application."
    },
    {
        title: "Powerpoint Analyser For Venture Capital",
        description: "Developed a tool that analyses startup pitch decks, extracts relevant information, and performs due diligence checks on founders, business models, and market sizing. Generates a score for the startup based on extracted information, addressing the critical need for rapid decision-making in the current AI investment boom."
    },
    {
        title: "Recreating Apple GenMoji",
        description: "Fine-tuned SDXL Lightning image generation model with emoji datasets to recreate the iOS 18 GenMoji feature for personalized emoji generation."
    },
    {
        title: "CapGemini DataCamp",
        description: "Contributed to a team project analysing customer feedback via sentiment analysis, utilising BERT and GPT-3.5 for data scraped from Trustpilot. Enhanced client's customer satisfaction through actionable insights derived from advanced NLP techniques."
    },
    {
        title: "Business Strategy Projects",
        description: "Various projects including: Customer Churn Prediction (BGC X) for lifetime value estimation; L'Oréal Marketing Mix Analysis for budget optimization; Luxury Brand Event Optimization (Eleven Consulting) using causality techniques; Unibail-Rodamco-Westfield Retail Analysis covering 20+ European malls."
    }
];
...
export const EDUCATION = [
    {
        ...
        year: "2024/2025",
        description: "Focused on real-world business challenges through data-driven solutions. Currently writing master's dissertation on structure and hierarchy effects in multi-agent systems for coding benchmarks like SWE-Bench.",
        courses: "Algorithmic Fairness and Interpretability, Causal Inference, ML Ops, Deep Learning, Reinforcement Learning, AI Ethics, Strategy and Data",
        researchPaper: {
            title: "The Hybridization of Consultancy Work",
            description: "Designed sophisticated human-AI partnership system with hierarchical multi-agent architecture and dynamic knowledge graph integration. Projected 62% reduction in proposal creation time.",
    ...
    },
    {
        ...
        degree: "Master in Data Science and AI for Business",
        year: "2023/2024",
        description: "Honed expertise in key disciplines including Statistics, Machine Learning, Database Management, Deep Learning, and Optimization.",
